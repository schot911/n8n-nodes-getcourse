                ...
                if (resource === 'user') {
                    if (operation === 'create' || operation === 'update') {
                        ...
                        if (additionalFields.city)
                            userData.city = additionalFields.city;
                        if (additionalFields.country)
                            userData.country = additionalFields.country;
                    ...
                    if (operation === 'create') {
                        ...
                        const offerName = this.getNodeParameter('offerName', i);
                        const additionalFields = this.getNodeParameter('dealAdditionalFields', i);
                        const dealData = {
                            user_email: userEmail,
                            offer_code: offerName,
                        };
                        if (additionalFields.price)
                            dealData.price = additionalFields.price;
                        if (additionalFields.comment)
                            dealData.comment = additionalFields.comment;
                        if (additionalFields.customFields && additionalFields.customFields.field) {
                            for (const field of additionalFields.customFields.field) {
