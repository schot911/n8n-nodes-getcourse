    ...
    describe('getParameterValue', () => {
        ...
        for (const testData of tests) {
            test(testData.description, () => {
                let result = src_1.NodeHelpers.getNodeParameters(testData.input.nodePropertiesArray, testData.input.nodeValues, false, false);
                expect(result).toEqual(testData.output.noneDisplayedFalse.defaultsFalse);
                result = src_1.NodeHelpers.getNodeParameters(testData.input.nodePropertiesArray, testData.input.nodeValues, true, false);
                expect(result).toEqual(testData.output.noneDisplayedFalse.defaultsTrue);
                result = src_1.NodeHelpers.getNodeParameters(testData.input.nodePropertiesArray, testData.input.nodeValues, false, true);
                expect(result).toEqual(testData.output.noneDisplayedTrue.defaultsFalse);
                result = src_1.NodeHelpers.getNodeParameters(testData.input.nodePropertiesArray, testData.input.nodeValues, true, true);
